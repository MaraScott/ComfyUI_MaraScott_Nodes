...
class BusNode:
    ...
    _INPUT_TYPES = ("MODEL", "CLIP", "VAE", "CONDITIONING", "CONDITIONING", "STRING", "STRING", "LATENT", "IMAGE", "MASK", "*")
    RETURN_TYPES = ("BUS", ) + _INPUT_TYPES
    _INPUT_NAMES = ("model", "vae", "positive", "negative", "positive (text)", "negative (text)", "latent", "image", "mask", "*")
