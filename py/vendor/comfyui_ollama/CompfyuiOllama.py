...
@PromptServer.instance.routes.post("/marascott/ollama/get_models")
...
# class Mara_OllamaGenerateAdvance_v1:
#     saved_context = None
...
# class Mara_OllamaSaveContext_v1:
#     def __init__(self):
...
# class Mara_OllamaLoadContext_v1:
#     def __init__(self):
#         self._base_dir = os.path.dirname(os.path.realpath(__file__)) + os.path.sep + "saved_context"
#     @classmethod
#     def INPUT_TYPES(s):
